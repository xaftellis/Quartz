...
{dateCreated}";
        ...
        public async System.Threading.Tasks.Task DeleteWebViewProfile(string profile)
        {
            ...
            CoreWebView2Environment environment = await CoreWebView2Environment.CreateAsync(null, $@"{Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData)}\Xaftellis\Quartz\UserData\WebView2\", environmentOptions);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SettingsService.Set("displayFullURLs", "false");
