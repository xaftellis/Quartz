...
namespace Quartz.Services
{
    public class ProfileService
    {
        ...
        private static string _jsonPath = System.IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + @"\Xaftellis\Quartz\UserData\jsons", "profiles.json");
        ...
        public System.Drawing.Image GetProfilePicture(Guid id)
        {
            ...
            string path = $@"{Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData)}\Xaftellis\Quartz\UserData\pictures\{profile.profilePicture}";
