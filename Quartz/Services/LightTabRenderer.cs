...
namespace Quartz
{
    public class LightTabRenderer : BaseTabRenderer
    {
        ...
        public LightTabRenderer(TitleBarTabs parentWindow)
            : base(parentWindow)
        {
            // Initialize the various images to use during rendering
            _activeLeftSideImage = Properties.Resources.TLeft;
            _activeRightSideImage = Properties.Resources.TRight;
            ...
            _background = IsWindows10 ? Properties.Resources.Background : null;
