...
namespace Quartz
{
    public class BlackTabRenderer : BaseTabRenderer
    {
        ...
        public BlackTabRenderer(TitleBarTabs parentWindow)
            : base(parentWindow)
        {
            // Initialize the various images to use during rendering
            _activeLeftSideImage = Properties.Resources.B_Left;
            _activeRightSideImage = Properties.Resources.B_Right;
            _activeCenterImage = Properties.Resources.B_Center;
            _inactiveLeftSideImage = Properties.Resources.B_InactiveLeft;
            _inactiveRightSideImage = Properties.Resources.B_InactiveRight;
            _inactiveCenterImage = Properties.Resources.B_InactiveCenter;
            _closeButtonImage = Properties.Resources.B_Close;
            _closeButtonHoverImage = Properties.Resources.B_CloseHover;
            _background = IsWindows10 ? Properties.Resources.B_Background : null;
            _addButtonImage = new Bitmap(Properties.Resources.B_Add);
            _addButtonHoverImage = new Bitmap(Properties.Resources.B_AddHover);
