...
namespace EasyTabs
{
	...
	public abstract class BaseTabRenderer : IDisposable
	{
		...
		internal virtual void ButtonPointerUp(Point cursor) { }
		internal virtual void CancelButtonPress() { }
		internal virtual bool BeginCaptionButtonPress(Point cursor) { return false; }
		internal virtual void EndCaptionButtonPress() { }
